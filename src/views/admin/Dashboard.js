...
const cardfulltable = {
  ...
  body: [
    [
      ...
      { text: "60%", progress: { value: 60, color: "red" } },
      {
        dropdown: {
          icon: "fas fa-cog",
    ...
    [
      ...
      { text: "73%", progress: { value: 73, color: "red" } },
      {
        dropdown: {
          icon: "fas fa-cog",
          button: { color: "white", size: "sm" },
    ...
    [
      ...
      { text: "90%", progress: { value: 90, color: "teal" } },
      {
        dropdown: {
          icon: "fas fa-cog",
          button: { color: "white", size: "sm" },
...
const footeradmin = {
  copyright: {
    ...
    target: "_blank",
    children: "Copyright © 2022 Creative Tim",
  },
  links: [
    {
      href: "https://www.creative-tim.com?ref=npr-footeradmin",
